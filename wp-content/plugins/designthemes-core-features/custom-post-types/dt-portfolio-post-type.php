	...
	class DTPortfolioPostType {
		...
		function createPostType() {
			...
			if( function_exists( 'classymissy_opts_get' ) ) {
				$portslug =	classymissy_opts_get( 'single-portfolio-slug', 'dt_portfolios' );
				$taxslug  =	classymissy_opts_get( 'portfolio-category-slug', 'portfolio_entries' );
			}

			$labels = array (
					'name' => esc_html__( 'Portfolios', 'classymissy-core' ),
					'all_items' => esc_html__( 'All Portfolios', 'classymissy-core' ),
					'singular_name' => esc_html__( 'Portfolio', 'classymissy-core' ),
					'add_new' => esc_html__( 'Add New', 'classymissy-core' ),
					'add_new_item' => esc_html__( 'Add New Portfolio', 'classymissy-core' ),
					'edit_item' => esc_html__( 'Edit Portfolio', 'classymissy-core' ),
					'new_item' => esc_html__( 'New Portfolio', 'classymissy-core' ),
					'view_item' => esc_html__( 'View Portfolio', 'classymissy-core' ),
					'search_items' => esc_html__( 'Search Portfolios', 'classymissy-core' ),
					'not_found' => esc_html__( 'No Portfolios found', 'classymissy-core' ),
					'not_found_in_trash' => esc_html__( 'No Portfolios found in Trash', 'classymissy-core' ),
					'parent_item_colon' => esc_html__( 'Parent Portfolio:', 'classymissy-core' ),
					'menu_name' => esc_html__( 'Portfolios', 'classymissy-core' ) ,					
			);
			
			$args = array (
					'labels' => $labels,
					'hierarchical' => false,
					'description' => esc_html__( 'This is custom post type portfolios', 'classymissy-core' ),
					'supports' => array (
							'title',
							'editor',
							'comments',
			...
			register_taxonomy ( 'portfolio_entries', array (
					...
					"hierarchical" => true,
					"label" => esc_html__( "Categories",'classymissy-core' ),
					"singular_label" => esc_html__( "Category",'classymissy-core' ),
		...
		function dt_add_portfolio_meta_box() {
			add_meta_box ( "dt-portfolio-default-metabox", esc_html__( 'Default Options', 'classymissy-core' ), array (
					$this,
					'dt_default_metabox' 
		...
		function dt_portfolios_edit_columns($columns) {
			...
			$newcolumns = array (
				...
				"dt_portfolio_thumb" => esc_html__("Image", "classymissy-core"),
				"title" => esc_html__("Title", "classymissy-core"),
				"author" => esc_html__("Author", "classymissy-core")
			);

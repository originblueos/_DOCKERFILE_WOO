...
<div class="sub-title custom-box">
    <div class="column one-sixth"><?php esc_html_e( 'Title Background','classymissy-core');?></div>
    <div class="column five-sixth last">
        <div class="two-third column image-preview-container" style="width:60%;">
            ...
            <input type="button" value="<?php esc_html_e('Upload','classymissy-core');?>" class="upload_image_button show_preview" />
            <input type="button" value="<?php esc_html_e('Remove','classymissy-core');?>" class="upload_image_reset" />
            <?php if( !empty($subtitlebg) ) classymissy_adminpanel_image_preview($subtitlebg );?>
            <p class="note"><?php esc_html_e('Upload an image for the sub title background','classymissy-core');?></p>
        </div>
        <div class="one-eighth column"></div>
        <div class="one-third column last">
            <label><?php esc_html_e('Opacity','classymissy-core');?></label>
            ...
            <select name="sub-title-opacity">
                <option value=""><?php esc_html_e("Select",'classymissy-core');?></option>
            ...
            <p class="note"><?php esc_html_e('Select background color opacity','classymissy-core');?></p>
        </div>    
    </div>
</div>
...
<div class="sub-title custom-box">
    ...
    <div class="column five-sixth last">
        <div class="column one-third">
            <label><?php esc_html_e('Background Repeat','classymissy-core');?></label>
            ...
            <p class="note"><?php esc_html_e('Select how would you like to repeat the background image','classymissy-core');?></p>
        </div>

        <div class="column one-third">
            <label><?php esc_html_e('Background Position','classymissy-core');?></label>
            ...
            <p class="note"><?php esc_html_e('Select how would you like to position the background','classymissy-core');?></p>
        </div>

        <div class="column one-third last">
        <?php $label = 		esc_html__('Background Color','classymissy-core');
              ...
              $tooltip = 	esc_html__('Select background color for sub title section e.g. #f2d607','classymissy-core'); ?>
...
<div id="page-layout" class="custom-box">
    <div class="column one-sixth"><label><?php esc_html_e('Layout','classymissy-core');?> </label></div>
    <div class="column five-sixth last">
        ...
        <p class="note"> <?php esc_html_e("You can choose between a left, right or no sidebar layout.",'classymissy-core');?> </p>
    </div>
</div><!-- Layout End-->
<?php 
...
<div id="widget-area-options" <?php echo ($sidebar_both);?>>
	<div id="left-sidebar-container" class="page-left-sidebar" <?php echo ($sidebar_left); ?>>
		...
		<div id="page-commom-sidebar" class="sidebar-section custom-box">
			<div class="column one-sixth"><label><?php esc_html_e('Show Standard Left Sidebar','classymissy-core');?></label></div>
			<div class="column five-sixth last"><?php 
				...
				<p class="note"> <?php esc_html_e('Yes! to show "Standard Left Sidebar" on this page.','classymissy-core');?> </p>
			 </div>
		...
		<div id="page-sidebars" class="sidebar-section custom-box page-widgetareas">
			<div class="column one-sixth"><label><?php esc_html_e('Choose Widget Area - Left Sidebar','classymissy-core');?></label></div>
			<div class="column five-sixth last"><?php
				...
				<select class="dt-chosen-select" name="dttheme[widgetareas-left][]" multiple="multiple" data-placeholder="<?php esc_attr_e('Select Widget Area', 'classymissy-core');?>"><?php
	...
	<div id="right-sidebar-container" class="page-right-sidebar" <?php echo ($sidebar_right); ?>>
		...
		<div id="page-commom-sidebar" class="sidebar-section custom-box page-right-sidebar">
			<div class="column one-sixth"><label><?php esc_html_e('Show Standard Right Sidebar','classymissy-core');?></label></div>
			<div class="column five-sixth last"><?php 
				...
				<p class="note"> <?php esc_html_e('Yes! to show "Standard Right Sidebar" on this page.','classymissy-core');?> </p>
			 </div>
		</div><!-- Standard Sidebar Right End-->

		<!-- 3. Choose Widget Areas Start -->
		<div id="page-sidebars" class="sidebar-section custom-box page-widgetareas">
			<div class="column one-sixth"><label><?php esc_html_e('Choose Widget Area - Right Sidebar','classymissy-core');?></label></div>
			<div class="column five-sixth last"><?php
				...
				$widgets = classymissy_option('widgetarea','custom');?>
				<select class="dt-chosen-select" name="dttheme[widgetareas-right][]" multiple="multiple" data-placeholder="<?php esc_attr_e('Select Widget Area', 'classymissy-core');?>"><?php
					echo "<option value=''></option>";
					if( isset( $widgets ) ):
						foreach ( $widgets as $widget ) :
							$id = mb_convert_case($widget, MB_CASE_LOWER, "UTF-8");
...
<div id="portfolio-layout" class="custom-box">
	<div class="column one-sixth">
		<label><?php esc_html_e('Portfolio Layout','classymissy-core');?> </label>
	</div>
	<div class="column five-sixth last">
		...
		<p class="note"> <?php esc_html_e("You can choose between a left, right or full width portfolio layout.",'classymissy-core');?> </p>
	</div>
...
<div class="custom-box">
	<div class="column one-sixth">
		<label><?php esc_html_e('Masonry Size','classymissy-core');?> </label>
	</div>
	<div class="column five-sixth last">
		...
		<select name="masonry-size" class="dt-chosen-select">
			<?php  $array = array(
				...
				'grid-sizer-1' => esc_html__('Grid Size 1','classymissy-core'),
				'grid-sizer-2' => esc_html__('Grid Size 2','classymissy-core'),
				'grid-sizer-3' => esc_html__('Grid Size 3','classymissy-core'),
				'grid-sizer-4' => esc_html__('Grid Size 4','classymissy-core'),
				'grid-sizer-5' => esc_html__('Grid Size 5','classymissy-core'));

			foreach( $array as $k => $v): ?>
				<option value="<?php echo esc_attr($k);?>" <?php selected($k,$masonry);?>><?php echo esc_attr($v);?></option>
			<?php endforeach;?>
		</select>
        <p class="note"> <?php esc_html_e("It works with portfolio infinite shortcode only",'classymissy-core');?> </p>
	</div>	
</div><!-- Masonry Size -->
...
<div class="custom-box">
	<div class="column one-sixth">
		<label><?php esc_html_e('Images','classymissy-core');?> </label>
	</div>
	<div class="column five-sixth last">
		<div class="dt-media-btns-container">
			<a href="#" class="dt-open-media button button-primary"><?php esc_html_e( 'Click Here to Add Images', 'classymissy-core' );?> </a>
			<a href="#" class="dt-add-video button button-primary"><?php esc_html_e( 'Click Here to Add Video', 'classymissy-core' );?> </a>
		</div>
		<div class="clear"></div>
...
$fields = classymissy_opts_get( 'portfolio-custom-fields', array() );
$fields = array_unique(array_filter($fields));

if(!empty($fields)) : ?>
    <div class="custom-box">
        <div class="column one-sixth">
            <label><?php esc_html_e('Additional Fields','classymissy-core');?></label>
        </div>
        <div class="column five-sixth last">
            <div class="meta-fields">
				<div class="column one-fourth" style="text-align:center;">
                	<strong><?php esc_html_e('Title','classymissy-core');?></strong>
                </div>
                <div class="column three-fourth last">
                	<strong><?php esc_html_e('Value','classymissy-core');?></strong>
                </div>
            ...
            <p class="note"> <?php esc_html_e("Here you can change Additional field title & values for this item.",'classymissy-core');?> </p>
        </div>
    </div><?php

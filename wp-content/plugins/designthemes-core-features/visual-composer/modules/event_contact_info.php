...
function dt_sc_event_contact_info_vc_map() {
	...
	vc_map( array(
		"name" => esc_html__("Event contact Info", 'classymissy-core'),
		"base" => "dt_sc_event_contact_info",
		"icon" => "dt_sc_event_contact_info",
		"category" => DT_VC_CATEGORY,
		"description" => esc_html__("Add event contact info",'classymissy-core'),
		"params" => array(
			...
			array(
      		...
      		array(
      			...
      			'param_name' => 'color',
      			'value' => $variations,      			
      			'description' => esc_html__( 'Select color', 'classymissy-core' ),
      		),

...
function dt_sc_masonry_portfolios_vc_map() {
	...
	vc_map( array(
		"name" => esc_html__( "Infinite Portfolios", 'classymissy-core' ),
		...
		"params" => array(
			...
			array(
				'type' => 'autocomplete',
				'heading' => esc_html__( 'Choose Category', 'classymissy-core' ),
				...
				'settings' => array(
					...
					'delay' => 500,
					'auto_focus' => true,),
				'description' => esc_html__( 'Enter portfolio categories to show from it', 'classymissy-core' ),
			),

			array(
				'type' => 'textfield',
				'heading' => esc_html__( 'Total items', 'classymissy-core'),
				'param_name' => 'posts_per_page',
			),

			array(
				'type' => 'dropdown',
				'heading' => esc_html__( 'Display Style', 'classymissy-core' ),
				'param_name' => 'display_style',
				'value' => array(
					esc_html__('Show all','classymissy-core') => 'all',
					esc_html__('Load more','classymissy-core') => 'load-more',
					esc_html__('Lazy loading','classymissy-core') => 'lazy',
				),
				'description' => esc_html__( 'Select display style for grid.', 'classymissy-core' )
			),

			array(
				'type' => 'textarea',
				'heading' => esc_html__( 'Warning Message', 'classymissy-core'),
				'param_name' => 'warning',
			),			
		)
	) );

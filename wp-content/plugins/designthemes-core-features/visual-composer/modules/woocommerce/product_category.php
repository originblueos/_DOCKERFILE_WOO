<?php
add_action( 'vc_before_init', 'dt_sc_product_category_vc_map' );
function dt_sc_product_category_vc_map() {
	vc_map( array(
		'name' => __( 'Products Category', 'js_composer' ),
		'base' => 'dt_sc_product_categories',
...
add_shortcode('dt_sc_product_categories', 'dt_sc_product_categories' );
function dt_sc_product_categories( $attrs, $content = null ) {
	...
	$ordering_args = WC()->query->get_catalog_ordering_args( $attrs['orderby'], $attrs['order'] );

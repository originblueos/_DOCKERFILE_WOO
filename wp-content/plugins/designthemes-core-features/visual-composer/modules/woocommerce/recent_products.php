<?php 
add_action( 'vc_before_init', 'dt_sc_recent_products_vc_map' );
function dt_sc_recent_products_vc_map() {
	vc_map( array( 
		'name' => __( 'Recent products', 'js_composer' ),
		'base' => 'dt_sc_recent_products',
...
# Shortcode
add_shortcode( 'dt_sc_recent_products', 'dt_sc_recent_products' );
function dt_sc_recent_products( $attrs, $content = null ) {
	...
	$woocommerce_loop['name'] = 'dt_sc_recent_products';

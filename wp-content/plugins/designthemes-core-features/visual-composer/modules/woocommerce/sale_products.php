<?php 
add_action( 'vc_before_init', 'dt_sc_sale_products_vc_map' );
function dt_sc_sale_products_vc_map() {
	vc_map( array( 
		'name' => __( 'Sale products', 'js_composer' ),
		'base' => 'dt_sc_sale_products',
...
# Shortcode
add_shortcode( 'dt_sc_sale_products', 'dt_sc_sale_products' );
function dt_sc_sale_products( $attrs, $content = null ) {

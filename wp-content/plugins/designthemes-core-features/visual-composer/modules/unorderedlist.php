...
function dt_sc_fancy_ul_vc_map() {
	...
	vc_map( array(
		"name" => esc_html__( "Fancy Unordered List", 'classymissy-core' ),
		"base" => "dt_sc_fancy_ul",
		"icon" => "dt_sc_fancy_ul",
		...
		"params" => array(
			...
			array(
				'type' => 'dropdown',
				'admin_label' => true,
				'heading' => esc_html__('Variation', 'classymissy-core'),
			...
			array(
				'type' => 'textarea_html',
				'heading' => esc_html__('Add Unordered List','classymissy-core'),
				'param_name' => 'content',

...
function dt_sc_toggle_vc_map() {
	vc_map( array(
		"name" => esc_html__( "Toggle", 'classymissy-core' ),
		"base" => "dt_sc_toggle",
		"category" => DT_VC_CATEGORY,
		'as_child' => array( 'only' => 'dt_sc_toggle_group' ),
		'description' => esc_html__( 'Section for Toggles', 'classymissy-core' ),
		"params" => array(
			...
			array(
				...
				'heading' => esc_html__( 'Title', 'classymissy-core' ),
      			'admin_label' => true,
				'description' => esc_html__( 'Enter section title (Note: you can leave it empty)', 'classymissy-core' )
			),

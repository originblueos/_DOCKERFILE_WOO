...
function dt_sc_accordion_vc_map() {
	...
	vc_map( array(
		"name" => esc_html__( "Accordions", 'classymissy-core' ),
		"base" => "dt_sc_accordion",
		"category" => DT_VC_CATEGORY,
		"show_settings_on_create" => false,
		"is_container" => true,
		"icon" => "dt_sc_accordion",
		'description' => esc_html__( 'Collapsible content panels', 'classymissy-core' ),
		"params" => array(
			...
			array(
				...
				'value' => array(
					...
					esc_html__( 'Frame', 'classymissy-core' ) => 'frame',
				),
      			'admin_label' => true,
				'heading' => esc_html__( 'Style', 'classymissy-core' ),
				'description' => esc_html__( 'Select accordion display style', 'classymissy-core' )
			),
			...
			array(
				...
				'description' => esc_html__( 'Select standard accordion display type', 'classymissy-core' ),
			...
			array(
				...
				'heading' => esc_html__( 'Type', 'classymissy-core' ),
				'description' => esc_html__( 'Select framed accordion display type', 'classymissy-core' ),
		...
		'custom_markup' => '<div class="wpb_accordion_holder wpb_holder clearfix vc_container_for_children">%content%</div>
			<div class="tab_controls">
				<a class="add_tab" title="' . esc_attr__( 'Add section', 'classymissy-core' ) . '">
				<span class="vc_icon"></span> <span class="tab-label">' . esc_html__( 'Add section', 'classymissy-core' ) . '</span></a>
			</div>',
		'default_content' => '[dt_sc_accordion_tab title="' . esc_html__( 'Section 1', 'classymissy-core' ) . '"][/dt_sc_accordion_tab]
			[dt_sc_accordion_tab title="' . esc_html__( 'Section 2', 'classymissy-core' ) . '"][/dt_sc_accordion_tab]'			
	) );

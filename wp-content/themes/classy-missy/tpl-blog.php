...
get_header();
    ...
    <section id="primary" class="<?php echo esc_attr( $page_layout );?>"><?php
		...
		$container_class = ( $post_style == 'entry-default' ) ? $container_class.' blog-default-style' : $container_class;
                        ...
                        <?php if( $post_style == "entry-date-left"): ?>
                                ...
                                <div class="entry-details">
                                    ...
                                    <?php if( array_key_exists('blog-post-excerpt',$tpl_default_settings) && array_key_exists('blog-post-excerpt-length',$tpl_default_settings) ):?>
                                    		<div class="entry-body"><?php echo classymissy_excerpt($tpl_default_settings['blog-post-excerpt-length']);?></div>
                                   <?php endif;?>
        ...
        <!-- **Pagination** -->
        <div class="pagination blog-pagination"><?php echo classymissy_pagination($the_query); ?></div><!-- **Pagination** -->
        <!-- Blog Template Ends -->

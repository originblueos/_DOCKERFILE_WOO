...
<div id="item-actions">
	...
	<?php if ( bp_group_is_visible() ) : ?>
		...
		if ( bp_group_has_moderators() ) :
			...
			<h3><?php esc_html_e( 'Group Mods' , 'classy-missy' ); ?></h3>
...
<div id="item-header-content">
	...
	<span class="activity"><?php printf( __( 'active %s', 'classy-missy' ), bp_get_group_last_active() ); ?></span>
	...
	<h3><?php esc_html_e( 'Group Admins', 'classy-missy' ); ?></h3>

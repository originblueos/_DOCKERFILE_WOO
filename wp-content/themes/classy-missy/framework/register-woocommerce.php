			...
			if( $style == 'woo-style1' || $style == 'woo-style2' ) {
				...
				$output .= '	<div class="wc_inline_buttons">';
									...
									if( class_exists('YITH_WCQV_Frontend') ) {
										...
										$output .= '<div class="wcqv_btn_wrapper wc_btn_inline"><a href="#" class="button yith-wcqv-button" data-product_id="' . $product->get_id() . '">' . $label . '</a></div>';
									}
									...
									if( class_exists('YITH_Woocompare_Frontend') && (get_option('yith_woocompare_compare_button_in_products_list') == 'yes') ) {
										...
										$output .= '<div class="wc_compare_btn_wrapper wc_btn_inline"><a href="'.esc_url_raw( add_query_arg( $url ) ).'" class="'.$class.'" data-product_id="'.$product->get_id().'" rel="nofollow">'.$button_text.'</a></div>';
									}
				$output .= '	</div>';

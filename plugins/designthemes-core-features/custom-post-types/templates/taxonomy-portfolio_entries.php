<?php get_header(); 
  $page_layout = classymissy_option('pageoptions','portfolio-archives-page-layout');
  ...
  if ( $show_sidebar ):
    ...
    <section id="primary" class="<?php echo esc_attr( $page_layout );?>"><?php
      ...
      $post_layout = classymissy_option('pageoptions','portfolio-archives-post-layout');
      $post_layout = isset( $post_layout ) ? $post_layout : 'one-half-column';

      $post_style = classymissy_option('pageoptions','portfolio-archives-post-style');
      $post_style = isset( $post_style ) ? $post_style : 'type1';

      $allow_space = classymissy_option('pageoptions','portfolio-allow-grid-space');
      ...
      <div class="pagination blog-pagination">
        <?php echo classymissy_pagination(); ?>
      </div><!-- **Pagination** -->

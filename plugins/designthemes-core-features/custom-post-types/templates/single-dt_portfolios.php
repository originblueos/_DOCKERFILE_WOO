<?php get_header();
   ...
   <section id="primary" class="<?php echo esc_attr( $page_layout );?>"><?php
                    ...
                    <?php echo !empty( $container_middle ) ? $container_middle : '';?>
                        ...
                        <div class="dt-portfolio-single-details">
                            ...
                            <?php if( array_key_exists('meta_title', $portfolio_settings) ): ?>
                            		<h3><?php esc_html_e('Project Details','classymissy-core');?></h3>
        ...
        <div class="post-nav-container">
        	<div class="post-prev-link"><?php previous_post_link('%link','<i class="fa fa-angle-double-left"> </i>'.esc_html__('Prev Entry','classymissy-core') );?> </div>
            <div class="post-next-link"><?php next_post_link('%link',esc_html__('Next Entry','classymissy-core').'<i class="fa fa-angle-double-right"> </i>');?></div>
        </div><!-- **Post Nav - End** --> 
        
        <?php # Related Portfolio
			  $related_post = classymissy_option('pageoptions','single-portfolio-related');
			 ...
			 if( isset($related_post) && $terms ) :?>
                ...
                <div class="related-portfolios">
                    <h3 class=""><span><?php esc_html_e('Related Projects','classymissy-core');?></span></h3><?php
					
					$post_class = "portfolio column dt-sc-one-third";
					$post_style = classymissy_option('pageoptions','single-portfolio-related-style');
        ...
        <?php #Portfolio Comments
			$post_comment = classymissy_option('pageoptions','single-portfolio-comments');

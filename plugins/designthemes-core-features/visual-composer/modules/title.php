...
function dt_sc_simple_heading_vc_map() {
	...
	vc_map( array(
		"name" => esc_html__( "Simple Heading", 'classymissy-core' ),
		...
		"params" => array(
			...
			array(
				...
				'value' => array(
					...
					esc_html__('Two Color','classymissy-core') => 'two-color',
					esc_html__('Two Border','classymissy-core') => 'two-border',
					esc_html__('Two Border With Sub Title','classymissy-core') => 'two-border-with-subtitle',
					esc_html__('Large With Sub Title Inside','classymissy-core') => 'large-with-subtitle-inside',
					esc_html__('Icon With Link', 'classymissy-core') => 'with-icon-link',
					esc_html__('Ribbon','classymissy-core') => 'ribbon',
					esc_html__('Script','classymissy-core') => 'script',
					esc_html__('Stripe','classymissy-core') => 'stripe',
					esc_html__('Split 2','classymissy-core') => 'mz-stripe',
					esc_html__('Split','classymissy-core') => 'split',
					esc_html__('Decoration','classymissy-core') => 'decoration',
					esc_html__('Triangle','classymissy-core') => 'triangle',
				),
				'std' => 'two-border',
				'admin_label' => true
			),
			...
			array(
				'type' => 'dropdown',
				'heading' => esc_html__('Heading tag','classymissy-core'),
				'param_name' => 'tag',
				'value' => array(
					'H1' => 'h1',
					'H2' => 'h2',
			...
			array(
				'type' => 'dropdown',
				'heading' => esc_html__('Sub Heading tag','classymissy-core'),
				'param_name' => 'subtag',
				'value' => array(
					'H1' => 'h1',
					'H2' => 'h2',
			...
			array(
				'type' => 'textfield',
				'heading' => esc_html__( 'Sub Text', 'classymissy-core' ),
				'param_name' => 'subtext',
				'value' => 'Lorem ipsum dolor',
				'dependency' => array( 'element' => 'type', 'value' => array( 'two-border-with-subtitle', 'script', 'stripe', 'large-with-subtitle-inside' ) )
			),
			...
			array(
				'type' => 'textfield',
				'heading' => esc_html__( 'Extra text', 'classymissy-core' ),
      		...
      		array(
				...
				'description' => esc_html__( 'Eg: fa fa-home or icon icon-compactcamera', 'classymissy-core' ),
				'dependency' => array( 'element' => 'type', 'value' => 'with-icon-link' )
			),

...
function dt_sc_domain_box_vc_map() {
	...
	vc_map( array(
		"name" => esc_html__( "Domain item", 'classymissy-core' ),
		"base" => "dt_sc_domain_box",
		"icon" => "dt_sc_domains_wrapper",
		"category" => DT_VC_CATEGORY,
		'as_child' => array( 'only' => 'dt_sc_domains_wrapper' ),
		'description' => esc_html__( 'Add domain item', 'classymissy-core' ),
		"params" => array(
			...
			array(
				'type' => 'textfield',
				'param_name' => 'domain',
				'heading' => esc_html__( 'Domain', 'classymissy-core' ),
				'description' => esc_html__( 'Enter domain eg: .com / .net', 'classymissy-core' ),
				'admin_label' => true
			),			
			...
			array(
				...
				'description' => esc_html__( 'Enter icon class eg: (pe-icon pe-check or fa fa-home)', 'classymissy-core' )
			),
			...
			array(
				...
				'description' => esc_html__( 'Enter price eg: $12.85', 'classymissy-core' ),
				'admin_label' => true
			),
			...
			array(
				...
				'param_name' => 'link',
				'description' => esc_html__( 'Add link', 'classymissy-core' ),
			),

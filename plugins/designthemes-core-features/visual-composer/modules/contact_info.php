...
function dt_sc_contact_info_vc_map() {
	vc_map( array(
		"name" => esc_html__("Contact Info", 'classymissy-core'),
		"base" => "dt_sc_contact_info",
		"icon" => "dt_sc_contact_info",
		"category" => DT_VC_CATEGORY,
		"description" => esc_html__("Add different types of contact info",'classymissy-core'),
		"params" => array(
			...
			array(
				...
				'param_name' => 'type',
				'value' => array( esc_html__('Type1','classymissy-core') => '',
					...
					esc_html__('Type7','classymissy-core') => 'type7',
					esc_html__('Type8','classymissy-core') => 'type8'),
				'std' => ''
			),

<?php 
add_action( 'vc_before_init', 'dt_sc_top_rated_products_vc_map' );
function dt_sc_top_rated_products_vc_map() {
	vc_map( array( 
		'name' => __( 'Top Rated products', 'js_composer' ),
		'base' => 'dt_sc_top_rated_products',
...
# Shortcode
add_shortcode( 'dt_sc_top_rated_products', 'dt_sc_top_rated_products' );
function dt_sc_top_rated_products( $attrs, $content = null ) {
	...
	add_filter( 'posts_clauses', array( $c , 'order_by_rating_post_clauses' ) );
	$products = new WP_Query( $query_args );
	remove_filter( 'posts_clauses', array( $c , 'order_by_rating_post_clauses' ) );

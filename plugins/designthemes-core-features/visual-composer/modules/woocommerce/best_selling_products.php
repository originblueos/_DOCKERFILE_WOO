<?php 
add_action( 'vc_before_init', 'dt_sc_best_selling_products_vc_map' );
function dt_sc_best_selling_products_vc_map() {
	vc_map( array( 
		'name' => __( 'Best Selling products', 'js_composer' ),
		'base' => 'dt_sc_best_selling_products',
...
# Shortcode
add_shortcode( 'dt_sc_best_selling_products', 'dt_sc_best_selling_products' );
function dt_sc_best_selling_products( $attrs, $content = null ) {

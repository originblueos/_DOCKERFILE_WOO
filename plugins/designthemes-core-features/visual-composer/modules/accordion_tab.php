...
function dt_sc_accordion_tab_vc_map() {
	vc_map( array(
		"name" => esc_html__( "Section", 'classymissy-core' ),
		...
		"params" => array(
			array(
				...
				'param_name' => 'title',
				'value' => esc_html__( 'Section', 'classymissy-core' ),
				'description' => esc_html__( 'Enter accordion section title', 'classymissy-core' )
			)
		),

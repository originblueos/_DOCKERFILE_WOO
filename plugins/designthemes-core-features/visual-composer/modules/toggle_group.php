...
function dt_sc_toggle_group_vc_map() {
	...
	vc_map( array(
		"name" => esc_html__( "Toggles", 'classymissy-core' ),
		...
		'description' => esc_html__( 'Toggle', 'classymissy-core' ),
		"params" => array(
			...
			array(
				...
				'description' => esc_html__( 'Select toggles display style', 'classymissy-core' )
			),
			...
			array(
				...
				'description' => esc_html__( 'Select framed toggles display type', 'classymissy-core' ),

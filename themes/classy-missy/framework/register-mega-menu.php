<?php
add_filter( 'wp_edit_nav_menu_walker', 'classymissy_modify_backend_walker' , 10 );
function classymissy_modify_backend_walker() {
	return 'ClassyMissy_ModifyBackendMenuWalker';
}
/* ---------------------------------------------------------------------------
 * Admin Menu Walker
 * This is copy of wp-admin/includes/nav-menu.php
 * --------------------------------------------------------------------------- */
class ClassyMissy_ModifyBackendMenuWalker extends Walker_Nav_Menu {
	...
	function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if ( ! empty( $item->_invalid ) ) {
			...
			$title = sprintf( esc_html__( '%s (Invalid)', 'classy-missy' ), $item->title );
		} elseif ( isset( $item->post_status ) && 'draft' == $item->post_status ) {
			$classes[] = 'pending';
			/* translators: %s: title of menu item in draft status */
			$title = sprintf( esc_html__('%s (Pending)', 'classy-missy'), $item->title );
		}
		...
		<li id="menu-item-<?php echo esc_attr($item_id); ?>" class="<?php echo esc_attr(implode(' ', $classes )); ?>">
			<dl class="menu-item-bar">
				<dt class="menu-item-handle">
					<span class="item-title"><span class="menu-item-title"><?php echo esc_html( $title ); ?></span> <span class="is-submenu" <?php echo ($submenu_text); ?>><?php esc_html_e( 'sub item', 'classy-missy' ); ?></span></span>
					<span class="item-controls">
						...
						<span class="item-order hide-if-js">
							...
							?>" class="item-move-up"><abbr title="<?php esc_attr_e('Move up', 'classy-missy'); ?>">&#8593;</abbr></a>
							|
							<a href="<?php
								echo wp_nonce_url(
									add_query_arg(
							...
							?>" class="item-move-down"><abbr title="<?php esc_attr_e('Move down', 'classy-missy'); ?>">&#8595;</abbr></a>
						</span>
						<a class="item-edit" id="edit-<?php echo esc_attr($item_id); ?>" title="<?php esc_attr_e('Edit Menu Item', 'classy-missy'); ?>" href="<?php
							echo ( isset( $_GET['edit-menu-item'] ) && $item_id == $_GET['edit-menu-item'] ) ? admin_url( 'nav-menus.php' ) : add_query_arg( 'edit-menu-item', $item_id, remove_query_arg( $removed_args, admin_url( 'nav-menus.php#menu-item-settings-' . $item_id ) ) );
						?>"><?php esc_html_e( 'Edit Menu Item', 'classy-missy' ); ?></a>
					</span>
				</dt>
			</dl>
			...
			<div class="menu-item-settings" id="menu-item-settings-<?php echo esc_attr($item_id); ?>">
				<?php if( 'custom' == $item->type ) : ?>
					<p class="field-url description description-wide">
						<label for="edit-menu-item-url-<?php echo esc_attr($item_id); ?>">
							<?php esc_html_e( 'URL', 'classy-missy' ); ?><br />
				...
				<p class="description description-thin">
					<label for="edit-menu-item-title-<?php echo esc_attr($item_id); ?>">
						<?php esc_html_e( 'Navigation Label', 'classy-missy' ); ?><br />
						<input type="text" id="edit-menu-item-title-<?php echo esc_attr($item_id); ?>" class="widefat edit-menu-item-title" name="menu-item-title[<?php echo esc_attr($item_id); ?>]" value="<?php echo esc_attr( $item->title ); ?>" />
					</label>
				</p>
				<p class="description description-thin">
					<label for="edit-menu-item-attr-title-<?php echo esc_attr($item_id); ?>">
						<?php esc_html_e( 'Title Attribute', 'classy-missy' ); ?><br />
				...
				<p class="field-link-target description">
					<label for="edit-menu-item-target-<?php echo esc_attr($item_id); ?>">
						...
						<?php esc_html_e( 'Open link in a new window/tab', 'classy-missy' ); ?>
					</label>
				</p>
				<p class="field-css-classes description description-thin">
					<label for="edit-menu-item-classes-<?php echo esc_attr($item_id); ?>">
						<?php esc_html_e( 'CSS Classes (optional)', 'classy-missy' ); ?><br />
						<input type="text" id="edit-menu-item-classes-<?php echo esc_attr($item_id); ?>" class="widefat code edit-menu-item-classes" name="menu-item-classes[<?php echo esc_attr($item_id); ?>]" value="<?php echo esc_attr( implode(' ', $item->classes ) ); ?>" />
					</label>
				</p>
				<p class="field-xfn description description-thin">
					<label for="edit-menu-item-xfn-<?php echo esc_attr($item_id); ?>">
						<?php esc_html_e( 'Link Relationship (XFN)', 'classy-missy' ); ?><br />
						<input type="text" id="edit-menu-item-xfn-<?php echo esc_attr($item_id); ?>" class="widefat code edit-menu-item-xfn" name="menu-item-xfn[<?php echo esc_attr($item_id); ?>]" value="<?php echo esc_attr( $item->xfn ); ?>" />
					</label>
				</p>
				<p class="field-description description description-wide">
					<label for="edit-menu-item-description-<?php echo esc_attr($item_id); ?>">
						<?php esc_html_e( 'Description', 'classy-missy' ); ?><br />
						<textarea id="edit-menu-item-description-<?php echo esc_attr($item_id); ?>" class="widefat edit-menu-item-description" rows="3" cols="20" name="menu-item-description[<?php echo esc_attr($item_id); ?>]"><?php echo esc_html( $item->description ); // textarea_escaped ?></textarea>
						<span class="description"><?php esc_html_e('The description will be displayed in the menu if the current theme supports it.', 'classy-missy'); ?></span>
					</label>
				</p>
                ...
                <p class="field-dt-use-as-megamenu description description-thin">
                    <label for="edit-menu-item-dt-use-as-megamenu-<?php echo esc_attr($item_id); ?>">
                        ...
                        <?php esc_html_e( 'Use As Mega Menu' ,  'classy-missy' ); ?>
                    </label>
                </p>
                ...
                <p class="field-dt-disable-text description description-thin">
                    <label for="edit-menu-item-dt-disable-text-<?php echo esc_attr($item_id); ?>">
                        ...
                        <?php esc_html_e( 'Disable Text' ,  'classy-missy'); ?>
                    </label>
                </p>
                ...
                <p class="field-dt-disable-link description description-thin">
                    <label for="edit-menu-item-dt-disable-link-<?php echo esc_attr($item_id); ?>">
                        ...
                        <?php esc_html_e( 'Disable Link' ,  'classy-missy' ); ?>
                    </label>
                </p>
                ...
                <p class="field-dt-fullwidth description description-thin">
                    <label for="edit-menu-item-dt-fullwidth<?php echo esc_attr($item_id); ?>">
                        ...
                        <?php esc_html_e( 'Enable Full width' ,  'classy-missy' ); ?>
                    </label>
                </p>
                ...
                <p class="field-dt-submenu-column description description-wide">
                    ...
                    <?php esc_html_e( 'Sub Menu Column Layout' ,  'classy-missy' ); ?><br />
                    ...
                    <span class="description"><?php esc_html_e('Select where to align the submenu.',  'classy-missy'); ?></span>
                    </label>
                </p>
                ...
                <p class="field-dt-menuicon description description-wide">
                    ...
                    <?php esc_html_e( 'Menu Icon' ,'classy-missy');?><br/>
                    ...
                    <span class="description"><?php esc_html_e('Please use font awesome icon ',  'classy-missy'); ?></span>
                    </label>
                </p>
                ...
                <p class="field-dt-menu-bg description description-wide">
                    ...
                    <?php esc_html_e( 'Menu Background' ,'classy-missy');?><br/>
                    ...
                    <span class="description"><?php esc_html_e('Please use image url',  'classy-missy'); ?></span>
                    </label>
                </p>
                ...
                <p class="field-dt-submenu-widget description description-wide">
                    ...
                    <?php esc_html_e( 'Display Widget Area' ,  'classy-missy' ); ?><br />
                        <select id="edit-menu-item-dt-submenu-widget-<?php echo esc_attr($item_id); ?>" class="widefat edit-menu-item-dt-submenu-widget" name="dt-submenu-widget[<?php echo esc_attr($item_id); ?>]">
                            <option value=""><?php esc_html_e('Select', 'classy-missy');?></option><?php
                    ...
                    <span class="description"><?php esc_html_e('Select widget area to show.',  'classy-missy'); ?></span>
                    </label>
                </p>
                ...
                <p class="field-dt-widgetarea-column description description-wide">
                        <label for="edit-menu-item-dt-submenu-column-<?php echo esc_attr($item_id); ?>">
                        <?php esc_html_e( 'Fill Widget Area Layout' ,  'classy-missy' ); ?><br />
                        ...
                        <span class="description"><?php esc_html_e('Only works if you choose widget area',  'classy-missy'); ?></span>
                        </label>
                </p>
				...
				<p class="field-move hide-if-no-js description description-wide">
					<label>
						<span><?php esc_html_e( 'Move', 'classy-missy' ); ?></span>
						<a href="#" class="menus-move-up"><?php esc_html_e( 'Up one', 'classy-missy' ); ?></a>
						<a href="#" class="menus-move-down"><?php esc_html_e( 'Down one', 'classy-missy' ); ?></a>
						<a href="#" class="menus-move-left"></a>
						<a href="#" class="menus-move-right"></a>
						<a href="#" class="menus-move-top"><?php esc_html_e( 'To the top', 'classy-missy' ); ?></a>
					</label>
				</p>
				...
				<div class="menu-item-actions description-wide submitbox">
					<?php if( 'custom' != $item->type && $original_title !== false ) : ?>
						<p class="link-to-original">
							<?php printf( esc_html__('Original: %s', 'classy-missy'), '<a href="' . esc_attr( $item->url ) . '">' . esc_html( $original_title ) . '</a>' ); ?>
						</p>
					<?php endif; ?>
					...
					); ?>"><?php esc_html_e( 'Remove', 'classy-missy' ); ?></a> <span class="meta-sep hide-if-no-js"> | </span> <a class="item-cancel submitcancel hide-if-no-js" id="cancel-<?php echo esc_attr($item_id); ?>" href="<?php echo esc_url( add_query_arg( array( 'edit-menu-item' => $item_id, 'cancel' => time() ), admin_url( 'nav-menus.php' ) ) );
						?>#menu-item-settings-<?php echo esc_attr($item_id); ?>"><?php esc_html_e('Cancel', 'classy-missy'); ?></a>
				</div>
 ...
 * To Save Menu Items
 * --------------------------------------------------------------------------- */
add_action( 'wp_update_nav_menu_item', 'classymissy_update_menu_item', 10, 3 );
function classymissy_update_menu_item( $menu_id, $menu_item_db, $args ) {
 ...
 * --------------------------------------------------------------------------- */
class ClassyMissy_FrontEndMenuWalker extends Walker {
	...
	function start_lvl( &$output, $depth = 0, $args = array()) {
		...
		if( !($this->mega_active) ){
			$animation = classymissy_option('layout','menu-hover-style');
			if( !empty( $animation ) ) {
	...
	function start_el( &$output, $item, $depth = 0, $args = array(), $current_object_id = 0 ) {
		...
		if($depth === 0 ) {
			if( $this->mega_active ) {
				...
				$class_names .= ( "true" == classymissy_option('layout','menu-boxshadow') ) ? ' with-box-shadow ' : '';
				$class_names .= ( "true" == classymissy_option('layout','menu-title-bg') ) ? ' menu-title-with-bg ' : '';			
				$class_names .= ( "true" == classymissy_option('layout','menu-links-bg') ) ? ' menu-links-with-bg ' : '';
				$class_names .= ( "true" == classymissy_option('layout','menu-links-border') ) ? ' menu-links-with-border ' : '';
				$class_names .= ( "true" ==  classymissy_option('layout','menu-link-arrow') ) ? ' menu-links-with-arrow  '.classymissy_option('layout','menu-link-arrow-style').' ':'';

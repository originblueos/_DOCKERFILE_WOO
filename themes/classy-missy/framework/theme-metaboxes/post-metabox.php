<?php
	#Post Meta Box
	add_action("add_meta_boxes", "classymissy_post_metabox");
	add_action('save_post','classymissy_post_meta_save');
	function classymissy_post_metabox(){
		add_meta_box("post-template-meta-container", esc_html__('Post Options', 'classy-missy'), "classymissy_post_settings","post", "normal", "default");
		add_meta_box("post-format-meta-container",esc_html__('Post Format Options', 'classy-missy'),"classymissy_post_format_settings","post","normal","default");
	}

	function classymissy_post_settings($args){
		global $post;
        ...
        <div class="sub-title custom-box">
            <div class="column one-sixth"><?php esc_html_e( 'Title Background','classy-missy');?></div>
        ...
        <div id="page-layout" class="custom-box">
			<div class="column one-sixth">                        
                <label><?php esc_html_e('Layout', 'classy-missy');?> </label>
            </div>
			<div class="column five-sixth last">  
                ...
                <p class="note"> <?php esc_html_e("You can choose a perfect layout for your post", 'classy-missy');?> </p>
            </div>
        </div><!-- Layout End-->
        ...
        <div class="custom-box">
			<div class="column one-sixth">
        	    <label><?php esc_html_e('Show Featured Image', 'classy-missy');?></label>
            </div>
			<div class="column five-sixth last">
                ...
                <p class="note"> <?php esc_html_e('YES! to show featured image', 'classy-missy');?> </p>
            </div>
        </div><!-- Featured Image Section End--><?php
		wp_reset_postdata();
    }
	
    function classymissy_post_format_settings( $args ) {
        global $post; 
        $tpl_default_settings = get_post_meta($post->ID,'_dt_post_settings',TRUE);
        $tpl_default_settings = is_array($tpl_default_settings) ? $tpl_default_settings  : array(); ?>
        ...
        <div id="dt-post-format-gallery">
            <div class="custom-box">
                <div class="column one-sixth"><label><?php esc_html_e('Image Gallery', 'classy-missy');?> </label></div>
                <div class="column five-sixth last">
                    <div class="dt-media-btns-container">
                        <a href="#" class="dt-open-media-for-gallery-post button button-primary"><?php esc_html_e( 'Click Here to Add Images', 'classy-missy' );?></a>
                    </div>
                    <div class="clear"></div>
        ...
        <div id="dt-post-format-video-audio">
            <div class="custom-box">
                <div class="column one-sixth"><label><?php esc_html_e('oEmbed URL', 'classy-missy');?> </label></div>
                <div class="column five-sixth last">
                    ...
                    <p class="note"><?php esc_html_e("Enter a URL that is compatible with WP's built-in oEmbed feature. This setting is used for your video and audio post formats.", 'classy-missy');?></p>
                </div>
            </div>

            <div class="custom-box">
                <div class="column one-sixth"><label><?php esc_html_e('Self Hosted URL', 'classy-missy');?> </label></div>
                <div class="column five-sixth last">
                    ...
                    <p class="note"><?php esc_html_e("Insert your self hosted video or audio url here.", 'classy-missy');?></p>                    
                </div>
            </div>
        </div><?php
    }
	
	function classymissy_post_meta_save($post_id){

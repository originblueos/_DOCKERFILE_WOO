<?php
	#Event Meta Box
	add_action("add_meta_boxes", "classymissy_event_metabox");
	add_action('save_post','classymissy_event_meta_save');
	function classymissy_event_metabox(){
		add_meta_box("event-template-meta-container", esc_html__('Event Options', 'classy-missy'), "classymissy_event_settings","tribe_events", "normal", "high");
	}

	function classymissy_event_settings($args){
		global $post;
        ...
        <div id="page-layout" class="custom-box">
			...
			<div class="column five-sixth last">  
                ...
                <p class="note"> <?php esc_html_e("You can choose between a left, right or no sidebar layout.", 'classy-missy');?> </p>
            </div>
        </div><!-- Layout End-->
            ...
            <div id="left-sidebar-container" class="page-left-sidebar" <?php echo ($sidebar_left); ?>>
                ...
                <div id="page-commom-sidebar" class="sidebar-section custom-box">
                    ...
                    <div class="column five-sixth last"><?php
                        ...
                        <p class="note"> <?php esc_html_e('Yes! to show "Standard Left Sidebar" on this page.', 'classy-missy');?> </p>
                     </div>
            ...
            <div id="right-sidebar-container" class="page-right-sidebar" <?php echo ($sidebar_right); ?>>
                ...
                <div id="page-commom-sidebar" class="sidebar-section custom-box page-right-sidebar">
                    ...
                    <div class="column five-sixth last"><?php 
                        ...
                        <p class="note"> <?php esc_html_e('Yes! to show "Standard Right Sidebar" on this page.', 'classy-missy');?> </p>
                     </div>
            ...
            <div class="column five-sixth last"> 
                <select name="dttheme-event-post-style" class="dt-chosen-select">
                    ...
                    <?php $event_styles =  array( 
                              'type1' => esc_html__('Classic','classy-missy'),
                              'type2' => esc_html__('Full Width','classy-missy'),
                              'type3' => esc_html__('Minimal Tab','classy-missy'),
                              'type4' => esc_html__('Clean','classy-missy'),
                              'type5' => esc_html__('Modern','classy-missy')
                          );
                          foreach( $event_styles as $es => $bv ):
                              echo "<option value='{$es}'".selected($selected,$es,false).">{$bv}</option>";
                          endforeach;?>
                </select>
                <p class="note"> <?php esc_html_e("Your event post page show at most selected style.",'classy-missy');?> </p>
            </div>
        </div><!-- Event Style End-->
	...
	function classymissy_event_meta_save($post_id){

<?php
	#Page Meta Box
	add_action("add_meta_boxes", "classymissy_page_metabox");
	add_action('save_post','classymissy_page_meta_save');
	function classymissy_page_metabox(){
		add_meta_box("page-template-slider-meta-container", esc_html__('Slider Options', 'classy-missy'), "classymissy_page_slider_settings", "page", "normal", "default");
		add_meta_box("page-template-meta-container", esc_html__('Default page Options', 'classy-missy'), "classymissy_page_settings", "page", "normal", "default");
	}

	#Slider Meta Box
	function classymissy_page_slider_settings($args){
		global $post;
        ...
        <div class="custom-box">
        	<div class="column one-sixth">
                <label><?php esc_html_e('Show Slider','classy-missy');?> </label>
            </div>
            <div class="column four-sixth last">
                ...
                <p class="note"> <?php esc_html_e('YES! to show slider on this page.','classy-missy');?> </p>
            </div>
        </div><!-- Show Slider End-->
        ...
        <div class="custom-box">
        	<div class="column one-sixth">
                <label><?php esc_html_e('Choose Slider','classy-missy');?></label>
            </div>
            <div class="column four-sixth last">
	            <?php $slider_types = array( '' => esc_html__('Select','classy-missy'),
											 'layerslider' => esc_html__('Layer Slider','classy-missy'),
											 'revolutionslider' => esc_html__('Revolution Responsive','classy-missy'),
											 'customslider' => esc_html__('Custom Slider Shortcode', 'classy-missy'));
					  ...
					  endforeach;
	 				 echo "</select>";?>
            <p class="note"> <?php esc_html_e("Select a slider for your page",'classy-missy');?> </p>
            </div>
    	...
    	<div id="slider-conainer"><?php
        	...
        	<div id="layerslider" class="custom-box" <?php echo ($layerslider);?>>
        		<h3><?php esc_html_e('Layer Slider','classy-missy');?></h3><?php
    			# Check layer slider active
    			if(classymissy_is_plugin_active('LayerSlider/layerslider.php')):
    				...
    				if(!empty($sliders)):
    					...
    					echo '			<label>'.esc_html__('Select LayerSlider','classy-missy').'</label>';
    					echo '		</div>';
    					echo ' 		<div class="column two-sixth">';
    					echo '			<select name="layerslider_id" class="dt-chosen-select">';
    					echo '				<option value="0">'.esc_html__("Select Slider",'classy-missy').'</option>';
    										...
    										endforeach;
    					echo '			</select>';
    					echo '			<p class="note">'.esc_html__("Choose Which LayerSlider you would like to use..",'classy-missy').'</p>';
    					echo '		</div>';
    					echo '	</div>';
						echo '</div>';
					else:
						echo '<p id="j-no-images-container">'.esc_html__('Please add at leat one layer slider','classy-missy').'</p>';
					endif;
				else:
					echo '<p id="j-no-images-container">'.esc_html__('Please activate Layered Slider','classy-missy').'</p>';
				endif; ?>
            </div><!-- Layered Slider End-->

            <!-- Revolution Slider -->
            <div id="revolutionslider" class="custom-box" <?php echo ($revolutionslider);?>>
            	<h3><?php esc_html_e('Revolution Slider','classy-missy');?></h3><?php
            	# Check revolution slider active
				if(classymissy_is_plugin_active('revslider/revslider.php')):
					$sld = new RevSlider();
					...
					if(!empty($sliders)):
						...
						echo '	<div class="bpanel-option-set">';
						echo ' <div class="column one-sixth">';
						echo '	<label>'.esc_html__('Select Slider','classy-missy').'</label>';
						echo ' 	</div>';
						...
						echo '	<select name="revolutionslider_id" class="dt-chosen-select">';
							...
							endforeach;
						echo '	</select>';
						echo '<p class="note">'.esc_html__("Choose which Revolution slider would you like to use!",'classy-missy').'</p>';
						echo ' 	</div>';
						echo '	</div>';
						echo '</div>';
					else:
						echo '<p id="j-no-images-container">'.esc_html__('Please add at leat one revolution slider','classy-missy').'</p>';
					endif;
				else:
					echo '<p id="j-no-images-container">'.esc_html__('Please activate Revolution Slider , and add at least one slider.','classy-missy').'</p>';
				endif; ?>
            </div><!-- Revolution Slider End-->

            <!-- Custom Slider Shortcode -->
            <div id="customslider" class="custom-box" <?php echo ($customslider);?>>
            	<h3><?php esc_html_e('Custom Slider','classy-missy');?></h3>
                <div class="one-half-content">
                	<div class="bpanel-option-set">
                        <div class="column one-sixth">
                            <label><?php esc_html_e('Shortcode', 'classy-missy'); ?></label>
                        </div>
                        <div class="column three-sixth">
                            ...
                            <p class="note"> <?php esc_html_e('Enter your custom slider shortcode.','classy-missy');?> </p>
                        </div>
                    </div>
                </div>
	...
	#Page Meta Box	
	function classymissy_page_settings($args){
        ...
        <div class="j-pagetemplate-container">
            	...
            	<div id="tpl-common-settings">
					...
					<div class="sub-title custom-box">
                        <div class="column one-sixth"><label><?php esc_html_e('Subtitle Section','classy-missy');?></label></div>
                        <div class="column five-sixth last">
                            <div class="one-fifth column">
                            	<label for="dttheme-enable-sub-title"><?php esc_html_e( 'Enable Section','classy-missy');?></label>
                                <div class="clear"></div>
                                ...
                                <p class="note"> <?php esc_html_e('YES! to enable subtitle section','classy-missy');?> </p>
                            </div>
                            
                            <div class="one-half column image-preview-container dt-custom-subtitle" style="width:57%;">
                                <label for="sub-title-bg"><?php esc_html_e( 'Title Background','classy-missy');?></label>
                                <div class="clear"></div>
                                ...
                                <?php if( !empty($subtitlebg) ) classymissy_adminpanel_image_preview($subtitlebg );?>
                            ...
                            <div class="one-fifth column last">
                                ...
                                $tooltip = 	esc_html__('Select background color for sub title section','classy-missy'); ?>
                    ...
                    <div class="sub-title custom-box">
                        ...
                        <div class="column five-sixth last">
                            <div class="column one-third">
                                <label><?php esc_html_e('Background Repeat','classy-missy');?></label>
                                ...
                                <p class="note"><?php esc_html_e('Select background image repeat style','classy-missy');?></p>
                            </div>
    
                            <div class="column one-third">
                                <label><?php esc_html_e('Background Position','classy-missy');?></label>
                                ...
                                <p class="note"><?php esc_html_e('Select background image position','classy-missy');?></p>
                            </div>
    
                            <div class="column one-third last">
                                <label><?php esc_html_e('Opacity','classy-missy');?></label>
                    ...
                    <div id="page-layout" class="custom-box">
                        <div class="column one-sixth"><label><?php esc_html_e('Layout','classy-missy');?> </label></div>
                        <div class="column five-sixth last">
                            ...
                            <p class="note"> <?php esc_html_e("You can choose a perfect layout for your page",'classy-missy');?> </p>
                        </div>
                    </div> <!-- Layout End-->
                    ...
                    <div id="widget-area-options" <?php echo ($sidebar_both);?>>
                        <div id="left-sidebar-container" class="page-left-sidebar" <?php echo ($sidebar_left); ?>>
                            ...
                            <div id="page-commom-sidebar" class="sidebar-section custom-box">
                                <div class="column one-sixth"><label><?php esc_html_e('Show Standard Left Sidebar','classy-missy');?></label></div>
                                <div class="column five-sixth last"><?php 
                                    ...
                                    <p class="note"> <?php esc_html_e('Yes! to show Standard Left Sidebar','classy-missy');?> </p>
                                 </div>
                            ...
                            <div id="page-sidebars" class="sidebar-section custom-box page-widgetareas">
                                <div class="column one-sixth"><label><?php esc_html_e('Choose Widget Area - Left Sidebar','classy-missy');?></label></div>
                                <div class="column five-sixth last"><?php
									...
									<select class="dt-chosen-select" name="dttheme[widgetareas-left][]" multiple="multiple" data-placeholder="<?php esc_attr_e('Select Widget Area', 'classy-missy');?>"><?php
                        ...
                        <div id="right-sidebar-container" class="page-right-sidebar" <?php echo ($sidebar_right); ?>>
                            ...
                            <div id="page-commom-sidebar" class="sidebar-section custom-box page-right-sidebar">
                                <div class="column one-sixth"><label><?php esc_html_e('Show Standard Right Sidebar','classy-missy');?></label></div>
                                <div class="column five-sixth last"><?php 
                                    ...
                                    <p class="note"> <?php esc_html_e('Yes! to show Standard Right Sidebar','classy-missy');?> </p>
                                 </div>
                            </div><!-- Standard Sidebar Right End-->

                            <!-- 3. Choose Widget Areas Start -->
                            <div id="page-sidebars" class="sidebar-section custom-box page-widgetareas">
                                <div class="column one-sixth"><label><?php esc_html_e('Choose Widget Area - Right Sidebar','classy-missy');?></label></div>
                                <div class="column five-sixth last"><?php
									...
									$widgets = classymissy_option('widgetarea','custom');?>
									<select class="dt-chosen-select" name="dttheme[widgetareas-right][]" multiple="multiple" data-placeholder="<?php esc_attr_e('Select Widget Area', 'classy-missy');?>"><?php
										echo "<option value=''></option>";
										if( isset( $widgets ) ):
											foreach ( $widgets as $widget ) :
												$id = mb_convert_case($widget, MB_CASE_LOWER, "UTF-8");
				...
				<div id="tpl-onepage-settings">
                    <div class="custom-box">
                    	<div class="column one-sixth">
                            <label><?php esc_html_e('Choose Menu','classy-missy');?></label>
                        </div>
                        <div class="column five-sixth last">
                            ...
                            <p class="note"> <?php esc_html_e("Select a menu items work as one page. Note: It doesn't work for split menu.",'classy-missy');?> </p>
                        </div>
                    </div>
               ...
               <div id="tpl-blog">
                  ...
                  <div class="custom-box">
                      <div class="column one-sixth">                
                          <label><?php esc_html_e('Posts Layout','classy-missy');?> </label>
                      </div>
                      <div class="column five-sixth last">
                          <ul class="dt-bpanel-layout-set">
                          <?php $posts_layout = array(	'one-column'=>	esc_html__("Single post per row.",'classy-missy'),
                                                        'one-half-column'=>	esc_html__("Two posts per row.",'classy-missy'),
                          ...
                          <p class="note"> <?php esc_html_e("You can choose perfect column style for your blog posts",'classy-missy');?> </p>
                      </div>
                  ...
                  <div class="custom-box">
                      <div class="column one-sixth"> 
                          <label><?php esc_html_e('Post Style','classy-missy');?></label>
                      </div>
                      <div class="column five-sixth last"> 
                          <select name="dttheme-blog-post-style" class="dt-chosen-select">
                              ...
                              <?php	$blog_styles =  array( 
                                        ...
                                        'blog-medium-style dt-blog-medium-highlight'=>esc_html__('Medium Highlight','classy-missy'),
                          ...
                          <p class="note"> <?php esc_html_e("Select a style to show blog post",'classy-missy');?> </p>
                      </div>
                  </div><!-- Post Style End-->
                  ...
                  <div class="custom-box">
                      <div class="column one-sixth">
                          <label><?php esc_html_e('Enable Readmore','classy-missy');?></label>
                      </div>
                      <div class="column five-sixth last">                     
                  ...
                  <div class="custom-box">
                      <div class="column one-sixth"> 
                          <label><?php esc_html_e('Read More Button','classy-missy');?></label>
                      </div>
                      <div class="column five-sixth last">
                          ...
                          <p class="note"> <?php esc_html_e("Enter button shortcode",'classy-missy');?> </p>
                      </div>
                  ...
                  <div class="custom-box">
                      <div class="column one-sixth">
                          <label><?php esc_html_e('Allow Excerpt','classy-missy');?></label>
                      </div>
                      <div class="column five-sixth last">                     
                          ...
                          <p class="note"> <?php esc_html_e('YES! to enable excerpt','classy-missy');?> </p>
                      </div>
                  ...
                  <div class="custom-box">
                      <div class="column one-sixth">
                          <label><?php esc_html_e('Excerpt Length','classy-missy');?></label>
                      </div>
                      <div class="column five-sixth last">
                          ...
                          <p class="note"> <?php esc_html_e("Limit! Number of characters from the content to appear on each blog post (Number Only)",'classy-missy');?> </p>
                      </div>
                  ...
                  <div class="custom-box">
                      <div class="column one-sixth"> 
                          <label><?php esc_html_e('Post per page','classy-missy');?></label>
                      </div>
                      <div class="column five-sixth last"> 
                          <select name="dttheme-blog-post-per-page" class="dt-chosen-select">
                              <option value="-1"><?php esc_html_e("All",'classy-missy');?></option>
                          ...
                          <p class="note"> <?php esc_html_e("Select number of posts per page.",'classy-missy');?> </p>
                      </div>
                  </div><!-- Post Count End-->
                  ...
                  <div class="custom-box">
                      <div class="column one-sixth">
                          <label><?php esc_html_e('Choose Categories','classy-missy');?></label>
                      </div>
                      <div class="column five-sixth last"><?php
						  ...
						  <select class="dt-chosen-select" name="dttheme[blog][cats][]" multiple="multiple" data-placeholder="<?php esc_attr_e('Select Categories', 'classy-missy');?>"><?php
							  echo "<option value=''></option>";
							  foreach ( $cats as $cat ) :
						  ...
						  <p class="note"> <?php esc_html_e("Select categories to exclude from your blog page.",'classy-missy');?> </p>
                      </div>
                  </div><!-- Categories End-->

                <!-- Post Meta-->
                <div class="custom-box">
	                <h3><?php esc_html_e('Post Meta Options','classy-missy');?></h3>
                	<?php $post_meta = array(
							array(
								"id"=>		"show-postformat-info",
								"label"=>	esc_html__("Show the post format info.",'classy-missy'),
								"tooltip"=>	esc_html__("By default the post format info will display when viewing your posts. You can easily disable it here.",'classy-missy')
							), array(
								"id"=>		"show-author-info",
								"label"=>	esc_html__("Show the Author info.",'classy-missy'),
								"tooltip"=>	esc_html__("By default the author info will display when viewing your posts. You can easily disable it here.",'classy-missy')
							), array(
								"id"=>		"show-date-info",
								"label"=>	esc_html__("Show the date info.",'classy-missy'),
								"tooltip"=>	esc_html__("By default the date info will display when viewing your posts. You can easily disable it here.",'classy-missy')
							),
							array(
								"id"=>		"show-comment-info",
								"label"=>	esc_html__("Show the comment",'classy-missy'),
								"tooltip"=>	esc_html__("By default the comment will display when viewing your posts. You can easily disable it here.",'classy-missy')
							),
							array(
								"id"=>		"show-category-info",
								"label"=>	esc_html__("Show the category",'classy-missy'),
								"tooltip"=>	esc_html__("By default the category will display when viewing your posts. You can easily disable it here.",'classy-missy')
							),
							array(
								"id"=>		"show-tag-info",
								"label"=>	esc_html__("Show the tag",'classy-missy'),
								"tooltip"=>	esc_html__("By default the tag will display when viewing your posts. You can easily disable it here.",'classy-missy')
							));
						$count = 1;
               ...
               <div id="tpl-portfolio">
                  ...
                  <div class="custom-box">
                      ...
                      <div class="column five-sixth last">
                          ...
                          <p class="note"> <?php esc_html_e("You can choose perfect column style for your portfolio items",'classy-missy');?> </p>
                      </div>      
                  ...
                  <div class="custom-box">
                      ...
                      <div class="column five-sixth last"> 
                          <select name="dttheme-portfolio-post-style" class="dt-chosen-select">
                              ...
                              <?php	$portfolio_styles =  array( 'type1' => esc_html__('Modern Title','classy-missy'), 'type2' => esc_html__('Title & Icons Overlay','classy-missy'), 'type3' => esc_html__('Title Overlay','classy-missy'),
                          ...
                          <p class="note"> <?php esc_html_e("Select a style to show portfolio item",'classy-missy');?> </p>
                      </div>
                  </div><!-- Post Style End-->
                  ...
                  <div class="custom-box">
                      <div class="column one-sixth">                
                          <label><?php esc_html_e('Allow Grid Space','classy-missy');?></label>
                      </div>
                      <div class="column five-sixth last">
                          ...
                          <p class="note"> <?php esc_html_e('YES! to allow grid space in between portfolio item','classy-missy');?> </p>
                      </div>
                  ...
                  <div class="custom-box">
                      <div class="column one-sixth">                
                          <label><?php esc_html_e('Allow Filters','classy-missy');?></label>
                      </div>
                      <div class="column five-sixth last">                       
                          ...
                          <p class="note"> <?php esc_html_e('YES! to allow filter options for portfolio items','classy-missy');?> </p>
                      </div>
                  </div><!-- Allow Filters -->
                  ...
                  <div class="custom-box">
                      ...
                      <div class="column five-sixth last"><?php
						  ...
						  <select class="dt-chosen-select" name="dttheme[portfolio][cats][]" multiple="multiple" data-placeholder="<?php esc_attr_e('Select Categories', 'classy-missy');?>"><?php
							  echo "<option value=''></option>";
							  foreach ( $cats as $cat ) :
								  $id = esc_attr ( $cat->term_id );
								  $title = esc_html ( $cat->name );
						  ...
						  <p class="note"> <?php esc_html_e("Select categories to show in portfolio items.",'classy-missy');?> </p>
                      </div>
                  </div><!-- Categories End-->                
	...
	function classymissy_page_meta_save($post_id){

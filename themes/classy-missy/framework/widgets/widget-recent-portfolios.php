<?php
class ClassyMissy_Portfolio_Widget extends WP_Widget {
	#1.constructor
	function __construct() {
		$widget_options = array("classname"=>'widget_popular_entries', 'description'=>esc_html__('To list out portfolio items', 'classy-missy'));
		parent::__construct(false,THEME_NAME.esc_html__(' Portfolio','classy-missy'),$widget_options);
	}
	...
	function widget($args, $instance) {
		...
		echo "<div class='recent-portfolio-widget'><ul>";
			 ...
			 if($the_query->have_posts()) :
			 	...
			 	echo "<li>".esc_html__('No Portfolio Entries found','classy-missy')."</li>";
			 endif;
			 wp_reset_postdata();
	 	echo "</ul></div>";			 
		echo ($after_widget);

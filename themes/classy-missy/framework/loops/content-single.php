	...
	<?php if( $post_style == "entry-date-left"):?>
			...
			<div class="entry-details">
				...
				<div class="entry-title">
					<h2><a href="<?php the_permalink();?>" title="<?php printf( esc_attr__('Permalink to %s','classy-missy'), the_title_attribute('echo=0'));?>"><?php the_title(); ?></a></h2>
				</div>
				...
				<?php edit_post_link( esc_html__( ' Edit ','classy-missy' ) ); ?>
			</div><!-- .entry-details -->
			...
			<div class="entry-details">
				...
				<div class="entry-meta">
					...
					<div class="author <?php echo esc_attr( $show_author_meta );?>">
						/ <i class="pe-icon pe-user"> </i>
						<a href="<?php echo get_author_posts_url(get_the_author_meta('ID'));?>" title="<?php esc_attr_e('View all posts by ', 'classy-missy'); echo get_the_author();?>">
...
<?php # Post Author Information Box
	$post_author_box = classymissy_option('pageoptions','single-post-authorbox');
	if( isset($post_author_box) ):?>
		<div class="dt-sc-hr"></div>
		<div class="dt-sc-clear"></div>
		<section class="author-info">
        	<h2><?php esc_html_e('About Author','classy-missy');?></h2>
			<div class="thumb">
...
<?php endif;
	...
	# Related Posts
	$related_post = classymissy_option('pageoptions','single-post-related');
	...
	#Post Comments
	$post_comment = classymissy_option('pageoptions','single-post-comments');
